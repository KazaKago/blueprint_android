package com.weathercock.cleanarchitecture.presentation.view.adapter;
...
import com.weathercock.cleanarchitecture.databinding.RecyclerForecastBinding;
...
public class ForecastRecyclerAdapter extends RecyclerView.Adapter<ForecastRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ForecastRecyclerAdapter.ViewHolder holder, int position) {
        ...
        holder.getBinding().setVariable(com.weathercock.cleanarchitecture.BR.viewModel, item);
