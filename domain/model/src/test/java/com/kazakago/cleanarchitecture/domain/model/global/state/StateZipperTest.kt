...
class StateZipperTest {
    ...
    @Test
    fun zipFixedFixed() {
        val state1 = State.Fixed<Int>(StateContent.NotExist())
        val state2 = State.Fixed<Int>(StateContent.NotExist())
    ...
    fun zipFixedLoading() {
        val state1 = State.Fixed<Int>(StateContent.NotExist())
        val state2 = State.Loading<Int>(StateContent.NotExist())
        val zippedState = state1.zip(state2) { content1, content2 -> content1 to content2 }
    ...
    fun zipFixedError() {
        val state1 = State.Fixed<Int>(StateContent.NotExist())
        val state2 = State.Error<Int>(StateContent.NotExist(), IllegalStateException())
        val zippedState = state1.zip(state2) { content1, content2 -> content1 to content2 }
    ...
    @Test
    fun zipLoadingFixed() {
        val state1 = State.Loading<Int>(StateContent.NotExist())
        val state2 = State.Fixed<Int>(StateContent.NotExist())
        val zippedState = state1.zip(state2) { content1, content2 -> content1 to content2 }
        assertThat(zippedState, `is`(instanceOf(State.Loading::class.java)))
    }
    ...
    @Test
    fun zipErrorFixed() {
        val state1 = State.Error<Int>(StateContent.NotExist(), IllegalStateException())
        val state2 = State.Fixed<Int>(StateContent.NotExist())
        val zippedState = state1.zip(state2) { content1, content2 -> content1 to content2 }
        assertThat(zippedState, `is`(instanceOf(State.Error::class.java)))
    }
    ...
    fun zipErrorError() {
        val state1 = State.Error<Int>(StateContent.NotExist(), IllegalStateException())
        val state2 = State.Error<Int>(StateContent.NotExist(), IllegalAccessException())
        val zippedState = state1.zip(state2) { content1, content2 -> content1 to content2 }
        assertThat(zippedState, `is`(instanceOf(State.Error::class.java)))
    ...
    fun zipManyFixed() {
        val state1 = State.Fixed<Int>(StateContent.NotExist())
        val state2 = State.Fixed<Int>(StateContent.NotExist())
        val state3 = State.Fixed<Int>(StateContent.NotExist())
        val state4 = State.Fixed<Int>(StateContent.NotExist())
        val state5 = State.Fixed<Int>(StateContent.NotExist())
    ...
    fun zipManyFixedLoading() {
        ...
        val state2 = State.Loading<Int>(StateContent.NotExist())
        val state3 = State.Fixed<Int>(StateContent.NotExist())
        val state4 = State.Loading<Int>(StateContent.NotExist())
        val state5 = State.Fixed<Int>(StateContent.NotExist())
        val zippedState = state1.zip(state2, state3, state4, state5) { content1, content2, content3, content4, content5 -> content1 to content2 to content3 to content4 to content5 }
        assertThat(zippedState, `is`(instanceOf(State.Loading::class.java)))
    }
    ...
    fun zipManyFixedLoadingError() {
        val state1 = State.Fixed<Int>(StateContent.NotExist())
        val state2 = State.Loading<Int>(StateContent.NotExist())
        val state3 = State.Error<Int>(StateContent.NotExist(), IllegalStateException())
        val state4 = State.Loading<Int>(StateContent.NotExist())
        val state5 = State.Fixed<Int>(StateContent.NotExist())
        val zippedState = state1.zip(state2, state3, state4, state5) { content1, content2, content3, content4, content5 -> content1 to content2 to content3 to content4 to content5 }
        assertThat(zippedState, `is`(instanceOf(State.Error::class.java)))
