...
fun LocalDateTime.formattedText(context: Context): String {
    return toLocalDate().formattedText(context) + " " + toLocalTime().formattedText(context)
}

fun LocalDate.formattedText(context: Context): String {
...
fun LocalTime.formattedText(context: Context): String {
